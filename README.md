...
## Kubernetes & Docker - - - [вверх](#Cодержание)
...
## UI/UX (интерфейсы) - - - [вверх](#Cодержание)
...
## Сети (IP, HTTP, TCP etc.) - - - [вверх](#Cодержание)
...
## Рефактринг, оптимзация - - - [вверх](#Cодержание)
